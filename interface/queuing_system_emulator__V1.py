...
from interface.cash_box import Ui_Frame
...
class Ui_queuing_system_emulator(object):
    def setupUi(self, queuing_system_emulator):
        ...
        queuing_system_emulator.resize(1050, 500)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 684, 476))
    ...
    def retranslateUi(self, queuing_system_emulator):
        ...
        queuing_system_emulator.setWindowTitle(_translate("queuing_system_emulator", "Эмулятор системы массового обслуживания"))
